import os,sys,re,time,json,io,pycurl
import requests,bs4,string,uuid
...
os.system('clear')
print(f'\x1b[38;5;196m►\x1b[38;5;46m WAITING SOME TIME\x1b[38;5;196m.\x1b[38;5;46m.\x1b[1;97m.\033[1;34m.');time.sleep(0.30)

W = "\x1b[97m"
G = "\x1b[38;5;46m"
R = "\x1b[38;5;196m"
X = f"{W}<{R}•{W}>"
orange = "\x1b[38;5;210m"
...
pvt = "\033[1;0m"
gren = "\x1b[38;5;154m"
my_color = [white,blue,green,cyan,yellow,orange,yelloww];warna = random.choice(my_color)
oks = []
cps = []
def clear():
    os.system('clear')
